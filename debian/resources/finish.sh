...
#app defaults
# Vi khong ket noi duoc voi co so du lieu trong luc cai, nen la phai copy tay nhe bro.
# cd /var/www/fusionpbx && /usr/bin/php /var/www/fusionpbx/core/upgrade/upgrade.php
cp -r /var/www/fusionpbx/app/switch/resources/scripts /usr/share/freeswitch/
