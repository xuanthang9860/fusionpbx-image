...
system_password='namitech'                      # random or a custom value
...
database_password='namitech'                    # random or a custom value (safe characters A-Z, a-z, 0-9)
...
application_transcribe=false                # Speech to Text
application_speech=false                    # Text to Speech
